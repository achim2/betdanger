    ...
    <div class="row">
        <div class="col-12">
            <main>
                ...
                <h2 class="section-name">my <?php echo $this->title; ?></h2>
                <section class="my-content">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="">
                            <a class="btn btn-success" href="<?php echo base_url("/content/$this->category/add_content"); ?>">Add content</a>
                        </div>
                    </div>
                                ...
                                foreach ($this->get_content as $content) {
                                    ...
                                    <tr class="" id="<?php echo $content->content_id; ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php //echo base_url("/content/edit_content/$content->category/$content->slug"); ?><!--"><span class="ti-pencil"></span></a>-->
